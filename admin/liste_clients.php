...
<div id="page_wrapper">
  <div id="sidenav" class="sidenav">
    <div class="sidenav_header">
      ...
      <a href="liste_clients.php" class="sidenav_link active">
    ...
    <header>
      <div class="text">
        <h2>Liste des clients non validés</h2> 
      </div>
  ...
  <?php
    ...
    echo ('<tr>'.
      ...
      '<td>'.$c["adresse"].'</td>'.
      '<td>'.$c["telephone"].'</td>'.
      '<td>.<a href="valider_client.php?idc='.$c["id"].'"title="valider ce client"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="m21.1 12.5l1.4 1.41l-6.53 6.59L12.5 17l1.4-1.41l2.07 2.08l5.13-5.17M10 17l3 3H3v-2c0-2.21 3.58-4 8-4l1.89.11L10 17m1-13a4 4 0 0 1 4 4a4 4 0 0 1-4 4a4 4 0 0 1-4-4a4 4 0 0 1 4-4Z"/></svg>
    </td>
    </tr>');
    ?>
  </tbody>
