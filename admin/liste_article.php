...
<div id="page_wrapper">
  <div id="sidenav" class="sidenav">
    <div class="sidenav_header">
      ...
      <a href="liste_article.php" class="sidenav_link active ">
      ...
      <a href="liste_commande.php" class="sidenav_link">
    ...
    <div>
        <a href="add_article.php" title="ajouter une catégorie"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M11 17h2v-4h4v-2h-4V7h-2v4H7v2h4v4Zm1 5q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22Z"/></svg></a>
      </div>
    <div>
  ...
  <?php
    ...
    echo ('<tr>'.
      ...
      '<td>'.$a["pu"].'DT</td>'.
      '<td>'.$a["qte"].'</td>'.
      '<td> <img  src="image/'.$a["image"].'" alt="'.$a["libelle"].'"></td>'.
      '<td>'.$a["categorie"].'</td>'.
      '<td>.<a href="Update_article.php?ida='.$a["id"].'"title="mette à jour"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M11 8v5l4.25 2.52l.77-1.28l-3.52-2.09V8H11zm10 2V3l-2.64 2.64A8.937 8.937 0 0 0 12 3a9 9 0 1 0 9 9h-2c0 3.86-3.14 7-7 7s-7-3.14-7-7s3.14-7 7-7c1.93 0 3.68.79 4.95 2.05L14 10h7z"/></svg></a>
      <a onclick="return popup()" href="Delete_article.php?ida='.$a["id"].'" title="supprimmer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M7 21q-.825 0-1.413-.588T5 19V6q-.425 0-.713-.288T4 5q0-.425.288-.713T5 4h4q0-.425.288-.713T10 3h4q.425 0 .713.288T15 4h4q.425 0 .713.288T20 5q0 .425-.288.713T19 6v13q0 .825-.588 1.413T17 21H7Zm2-5q0 .425.288.713T10 17q.425 0 .713-.288T11 16V9q0-.425-.288-.713T10 8q-.425 0-.713.288T9 9v7Zm4 0q0 .425.288.713T14 17q.425 0 .713-.288T15 16V9q0-.425-.288-.713T14 8q-.425 0-.713.288T13 9v7Z"/></svg></a>
    </td>
    </tr>');
    ?>
  </tbody>
...
function popup()
 {
  return confirm("voulez vous vraiment faire la suppression");
 }
  </script>
