...
<div id="page_wrapper">
  <div id="sidenav" class="sidenav">
    <div class="sidenav_header">
      ...
      <a href="liste_categorie.php" class="sidenav_link active">
