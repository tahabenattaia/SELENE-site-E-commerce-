...
<div class="card col-8 offset-5 mt-5" style="width: 18rem;">
  ...
  <button type="submit" <?php if (isset($_SESSION['etat'])&&$_SESSION['etat']==0 ||!isset($_SESSION['etat'])) {echo ("disabled"); $show=1;} ?> class="btn btn-outline-primary">Commander</button>
  </div> 
</form>
</div>
